...
class MainWindow(QMainWindow):
    ...
    def update_data(self):
        ...
        global temp
        print('Next update')
        if mone == 1 and not self.stop_publishing:
        ...
        if temp > 27 and not self.stop_publishing:
            print("Temperature exceeds 27°C, sending command to open windows.")
            self.mc.publish_to(DHT_topic, "too hot, open all windows")
            self.stop_publishing = True  # Set the flag to stop further publishing
